...
var Facebox = Class.create({
  ...
  reveal_with_overlay	: function(data, klass){
    this.settings.show_overlay = true;
  ...
  reveal	: function(data, klass){
    ...
    if(this.settings.show_overlay) this.show_overlay();
    ...
    if(!this.facebox.visible()) new Effect.Appear(this.facebox, {
      duration: .3
    });
    this.facebox.setStyle({
      'left': document.viewport.getWidth() / 2 - (this.facebox.getWidth() / 2) + 'px'
  ...
  close		: function(){
    if(this.settings.show_overlay) this.hide_overlay();
  ...
  click_handler	: function(elem, e){
    ...
    new Effect.Appear(this.facebox, {
      duration: .3
    });
  ...
  show_overlay: function() {
    ...
    // this.hide_selects();
    new Effect.Appear("facebox_overlay", {
      duration: 0.3
    });
  },
  ...
  hide_overlay: function() {
    // this.show_selects();
    new Effect.Fade("facebox_overlay", {
      duration: 0.3
    });
  },
  ...
  set_overlay_size: function() {
    ...
    $("facebox_overlay").style['height'] = (yScroll+20) + "px";
  },
