...
init(_) ->
	...
	PLChild = { process_list_sup, {process_list_sup, start_link, []}, permanent, 2000, supervisor, [process_list_sup]},
	...
	{ok, {{one_for_one, 1, 1}, [SMChild, SChild, NChild, PLChild, MSChild, CChild,  SGChild]}}.
